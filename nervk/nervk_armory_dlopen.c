...
static void draw_gun(void){
  ...
  if(pweapon==1){ gx=0.225f; gy=-0.238f; gz=-0.47f; }   /* the heavy gun rides lower-right */
  ...
  static const struct PartB shotgun[10]={
    {-0.052f,0.050f,-0.24f, 0.052f,0.052f,0.50f},  /* left barrel  */
    { 0.052f,0.050f,-0.24f, 0.052f,0.052f,0.50f},  /* right barrel */
    {-0.052f,0.050f,-0.495f,0.060f,0.060f,0.05f},  /* left bore mouth  (dark) */
    { 0.052f,0.050f,-0.495f,0.060f,0.060f,0.05f},  /* right bore mouth (dark) */
    {0,0.088f,-0.22f,       0.038f,0.020f,0.44f},  /* ventilated top rib */
    {0,-0.005f,0.055f,      0.185f,0.135f,0.27f},  /* receiver */
    {0,0.050f,-0.020f,      0.165f,0.060f,0.07f},  /* breech band (bright) */
    {0,-0.082f,-0.130f,     0.175f,0.075f,0.28f},  /* wooden forestock */
    {0,-0.155f,0.085f,      0.062f,0.135f,0.085f}, /* wooden grip */
    {0,-0.050f,0.255f,      0.140f,0.100f,0.22f}}; /* wooden stock */
  ...
  int np = pweapon==2?4:(pweapon==1?10:3);
  ...
  for(int p=0;p<np;p++){
    ...
    else if(pweapon==1){                                   /* shotgun materials */
      if(p<=1){ rg=0.98f; rb=1.16f; }                      /* twin steel barrels      */
      else if(p<=3){ rg=1.00f; rb=1.20f; mt=0.30f; }       /* dark bore mouths        */
      else if(p==4||p==5){ rg=1.00f; rb=1.13f; }           /* rib + receiver steel    */
      else if(p==6){ rg=1.00f; rb=1.18f; mt=1.20f; }       /* bright breech band      */
      else { rg=0.64f; rb=0.40f; mt=1.05f; }               /* warm walnut furniture   */
    }
    glBegin(GL_QUADS);
    for(int f=0;f<6;f++){
  ...
  if(flashT>0){
    ...
    glBegin(GL_QUADS);
    if(pweapon==1){
      for(int q=-1;q<=1;q+=2){ float ox=q*0.052f;
